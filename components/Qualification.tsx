  ...
  experience: [
    {
      ...
      date: '2024 - Present',
      description: 'Architecting and deploying modern web applications using React, Next.js, and Node.js. Focused on writing clean, maintainable, and highly optimized code.',
    },
    {
      id: 2,
      ...
      description: 'Mentored Class 9 and 10 students. This experience drastically improved my ability to break down complex logical problems into easily understandable steps.',
    }
  ]
};
...
export default function Qualification() {
  ...
  // Scroll tracking for the vertical line
  ...
  const containerVariants = {
    ...
    visible: { 
      opacity: 1, 
      transition: { 
        staggerChildren: 0.3, // প্রতিটি কার্ডের মাঝে ০.৩ সেকেন্ড গ্যাপ থাকবে
        delayChildren: 0.1 
      } 
    },
  };
  ...
  return (
    <section id="qualification" ref={sectionRef} className="py-32 relative z-10 overflow-hidden">
          ...
          <div className="flex items-center gap-2 p-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
            {['education', 'experience'].map((tab) => (
              ...
              >
                ...
                <span className={activeTab === tab ? 'text-white' : 'text-slate-500 group-hover:text-slate-300'}>
                  {tab}
                </span>
              </button>
            ))}
